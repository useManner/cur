...
namespace VDF.GUI.ViewModels {
	public partial class MainWindowVM : ReactiveObject {
		...
		public KeyValuePair<string, FileTypeFilter>[] TypeFilters { get; } = {
			new KeyValuePair<string, FileTypeFilter>("È«²¿",  FileTypeFilter.All),
			new KeyValuePair<string, FileTypeFilter>("ÊÓÆµ",  FileTypeFilter.Videos),
			new KeyValuePair<string, FileTypeFilter>("Í¼Æ¬",  FileTypeFilter.Images),
		};
