...
class DirectoriesDialog(QMainWindow):
    ...
    def _setupUi(self):
        ...
        hl.addWidget(label)
        self.appModeRadioBox = RadioBox(self, items=[tr("Standard"), tr("Music"), tr("Picture"), tr("Video")], spread=False)
    ...
    def _updateScanTypeList(self):
        ...
        scanner_instance = self.app.model.SCANNER_CLASS()
        scan_options = scanner_instance.get_scan_options()
        ...
        try:
            ...
            # Default to the first scan type if the selected type is not in the list
